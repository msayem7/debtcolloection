...
from ai_data_assistant.models import AIDataAssistantLog, ApiKeyProfile


class AIDataAssistantRequestSerializer(serializers.Serializer):
...
class AIDataAssistantResponseSerializer(serializers.Serializer):
...
class AIDataAssistantLogSerializer(serializers.ModelSerializer):
    class Meta:
        model = AIDataAssistantLog
        fields = '__all__'
